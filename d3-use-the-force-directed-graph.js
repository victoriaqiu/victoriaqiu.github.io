...
// Title: Dynamic Social Network Graph
// Author: victoriaqiu (@victoriaqiu)
// Version: 266
// Runtime version: 1

const m0 = {
  id: "d95a293e42d79542@266",
  variables: [
    {
      inputs: ["md"],
      value: (function(md){return(
md`# Dynamic Social Network Graph

Different color of dots represents different types of elite users. Different nodes are linked together if they are friends. We could figure out that the whole social network is quite stochastic in the term of types of elite. `
)})
    },
    {
